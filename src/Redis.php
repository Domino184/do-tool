...
class Redis
{
    ...
    //初始化
    public function __construct($db = 1, $auth = '', $host = '127.0.0.1', $port = 6379, $timeout = 3)
    {
    ...
    public function listGet($list, $index = 0, $end = null)
    {
        ...
        if ($end) {
            ...
            $return = $this->_REDIS->lIndex($list, $index);
        }
     ...
     */
    public function hashGet($hash, $type = 0, $key = array())
    {
        $return = null;
